...
spec-pre-epic-6-importer-gate.md; live-DB acceptance 2026-07-15: 38,261 rows (was 51,189), 0 dup oracle_ids, 0 game_changer NULL (53 TRUE), 241 deck refs repointed / 0 dangling; 33 rejects all reversible_card missing top-level type_line (fix = own spec, see deferred-work) — Epic 6 unblocked
