...
code review 2026-07-17: all ACs MET; 1 patch applied (combo-provisioning DB reads brought under DatabaseError→error contract + regression test), 2 deferred (transient-lock mislabel → data-layer; almost_included "matched" wording → 7.3), 7 dismissed
