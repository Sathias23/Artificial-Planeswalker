...
unavailable. Exactly two literals exist (`452px`, `1100px`), both cited to DESIGN.md beside the
value, both pinned by test. c2-7's 17px, c2-9's 480px and c4-4's 176px inherit a stated rule.
