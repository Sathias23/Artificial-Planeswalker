...
- [Source: docs/superpowers/specs/2026-06-20-mcp-server-architecture-design.md#7] — Claude skills suite shape ("`format-legality` — format rules, validation, sideboard guidance"); [#5] tool catalog; [#3 D4/D5] focused-suite + statelessness.
