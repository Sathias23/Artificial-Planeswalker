...
- [x] Sathias review -- accept each deck as plausible or log named divergences in the report; gate closes on completed review sheet (divergences become Epic 7 calibration inputs) -- *Owner: Sathias* -- **CLOSED 2026-07-17: all 20 accepted wholesale; calibration deferred to Epic 7 (cross-deck observations stand as calibration-input candidates)*
