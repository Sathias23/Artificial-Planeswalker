...
from src.agent.core import create_agent, run_agent_with_session
...
def bug_report_file(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("src.agent.tools.bug_report.Path", mock_path)
...
class TestBugReportEndToEnd:
    ...
    async def test_bug_report_tool_creates_file_and_entry(self, card_repository, bug_report_file):
        ...
        from src.agent.tools.bug_report import _write_bug_report_jsonl
    ...
    async def test_bug_report_captures_conversation_context(self, card_repository, bug_report_file):
        ...
        # Submit bug report
        from src.agent.core import _session_manager
        from src.agent.tools.bug_report import _format_conversation_context, _write_bug_report_jsonl
