...
Enable one-click card addition from synergy suggestions by displaying action buttons for each suggested card, reducing friction in deck-building workflows.
