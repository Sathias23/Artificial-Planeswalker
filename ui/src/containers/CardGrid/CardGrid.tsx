 ...
 *
 * No group headers and no deck list (c4-7). No empty-deck line — **c4-12** owns that copy
 * (EXPERIENCE.md:70), and this file must simply not crash or render something stray without it:
 * `boardsOf([])` returns three empty boards and the render below is an empty `<ul>` inside an
 * untitled panel, which is a place for c4-12 to put its line rather than a state pretending to be
 * one (Q10). No `deck_changed` refetch and no live region (Epic 5, c7-5).
 */
