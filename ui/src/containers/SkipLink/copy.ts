/**
 * The one word this component authors (story c4-11, AC 1, UX-DR31, UX-DR40).
 *
 ...
 * throughout. The same shape as every other `copy.ts` in the app.
 */

/**
 * The link's visible text, and therefore its accessible name (AC 1, UX-DR31).
 *
 ...
 * *"Skip past the deck grid"*, byte for byte. Unusually for this epic there is nothing to rule
 * here: no artefact disagrees with another, and no case, punctuation or wording decision was left
 ...
 * stops away after using this link, because c4-7's deck list sits between the two and puts a
 ...
 *
 * That residue is real, it is Q1's, and it is carried on **c8-6** by name rather than papered over
 * with wording.
 *
