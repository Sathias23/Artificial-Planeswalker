...
from src.ui.formatters import get_display_name
...
async def handle_pagination_signal(signal: dict[str, Any]) -> None:
    ...
    """
    from src.ui.formatters import create_pagination_actions
...
async def handle_disambiguation_signal(signal: dict[str, Any], user_message: str) -> None:
    ...
    """
    from src.ui.app import detect_disambiguation_context
