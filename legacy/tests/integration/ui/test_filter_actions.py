...
from legacy.ui.actions.filter_actions import on_set_format_filter, on_set_games_filter
...
def mock_chainlit_session():
    ...
    # Patch both the main module and legacy.ui.action_callbacks module
    ...
    async def test_set_format_filter_to_standard(
        ...
        with patch("legacy.ui.action_callbacks.remove_all_actions", new_callable=AsyncMock):
            with patch("legacy.ui.app.cl.Message") as mock_message_class:
                ...
                with patch("legacy.ui.actions.filter_actions._session_manager", session_manager):
