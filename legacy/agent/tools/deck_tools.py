...
async def view_deck(ctx: RunContext[AgentDependencies]) -> str:
    ...
    try:
        ...
        from legacy.ui.formatters import format_deck_for_display
...
async def list_decks(
    ...
    try:
        ...
        # Import formatter here to avoid circular import at module level
        from legacy.ui.formatters import format_deck_list
...
async def load_deck(
    ...
    try:
        ...
        # Import formatter here to avoid circular import at module level
        from legacy.ui.formatters import format_deck_summary
